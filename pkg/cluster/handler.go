...
type ClusterHandler interface {
	...
	IsResponsibleFor(ctx context.Context, req reconcile.Request, platformClient client.Client, cluster *clustersv1alpha1.Cluster) bool
	...
	HandleCreateOrUpdate(ctx context.Context, req reconcile.Request, platformClient client.Client, cluster *clustersv1alpha1.Cluster, access cluster.Cluster) (reconcile.Result, error)
	...
	HandleDelete(ctx context.Context, req reconcile.Request, platformClient client.Client, cluster *clustersv1alpha1.Cluster, access cluster.Cluster) (reconcile.Result, error)
	...
	AfterDeletion(ctx context.Context, req reconcile.Request, platformClient client.Client) (reconcile.Result, error)
}
...
type Funcs struct {
	IsResponsibleForFunc     func(ctx context.Context, req reconcile.Request, platformClient client.Client, cluster *clustersv1alpha1.Cluster) bool
	HandleCreateOrUpdateFunc func(ctx context.Context, req reconcile.Request, platformClient client.Client, cluster *clustersv1alpha1.Cluster, access cluster.Cluster) (reconcile.Result, error)
	HandleDeleteFunc         func(ctx context.Context, req reconcile.Request, platformClient client.Client, cluster *clustersv1alpha1.Cluster, access cluster.Cluster) (reconcile.Result, error)
	AfterDeletionFunc        func(ctx context.Context, req reconcile.Request, platformClient client.Client) (reconcile.Result, error)
}

var _ ClusterHandler = &Funcs{}

func (f *Funcs) IsResponsibleFor(ctx context.Context, req reconcile.Request, platformClient client.Client, cluster *clustersv1alpha1.Cluster) bool {
...
func (f *Funcs) HandleCreateOrUpdate(ctx context.Context, req reconcile.Request, platformClient client.Client, cluster *clustersv1alpha1.Cluster, access cluster.Cluster) (reconcile.Result, error) {
...
func (f *Funcs) HandleDelete(ctx context.Context, req reconcile.Request, platformClient client.Client, cluster *clustersv1alpha1.Cluster, access cluster.Cluster) (reconcile.Result, error) {
...
func (f *Funcs) AfterDeletion(ctx context.Context, req reconcile.Request, platformClient client.Client) (reconcile.Result, error) {
